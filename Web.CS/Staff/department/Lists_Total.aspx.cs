...
public partial class Staff_department_Lists_Total :Web.UI.Permissions
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Base.Fun.fun.pnumeric(departmentid))
        {
            ...
            str = Web.UI.Staff.department.ViewDepartment(StoresID, departmentid, starttime, endtime);
