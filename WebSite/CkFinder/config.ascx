...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		ResourceType type;
        //CkeditorPicSize = "0", CkeditorFileSize = "0", CkeditorFlashSize = "0";
		type = ResourceType.Add( "Files" );
		type.Url = BaseUrl + "files/";
		type.Dir = BaseDir == "" ? "" : BaseDir + "files/";
        type.MaxSize = int.Parse(Base.Fun.fun.IsZero(Base.Fun.fun.getapp("CkeditorFileSize")));
        ...
        type.MaxSize = int.Parse(Base.Fun.fun.IsZero(Base.Fun.fun.getapp("CkeditorPicSize")));
        ...
        type.MaxSize = int.Parse(Base.Fun.fun.IsZero(Base.Fun.fun.getapp("CkeditorFlashSize")));
