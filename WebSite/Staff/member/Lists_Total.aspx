<%@ Page Language="C#" AutoEventWireup="true" Inherits="Staff_member_Lists_Total" %>
<div id="SearchInputKHValue" style="padding:5px;text-align:left;">
    <div style="float:right"><input type="submit" name="button" id="Submit1" value="搜 索" onclick="AjaxFun('Staff/member/Lists_total.aspx','action=view&id=<%=departmentid%>&'+ReadInputValue('SearchInputKHValue'),' ','#departmentView');" icon="icon-zoom" /></div>
