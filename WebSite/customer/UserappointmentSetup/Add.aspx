<%@ Page Language="C#" AutoEventWireup="true" Inherits="customer_UserappointmentSetup_ADD" %>
<%if(!action.Equals("save")){ %>
<div id="UserappointmentSetupAdd">
<table class="table StyleView" border="0" cellspacing="0" scellpadding="0" width="100%">
    ...
    <tr>
        ...
        <td align="left" colspan="3" style="height:150px">
            <br/>
            <input type="text" name="num" class="validate[required]" value="0" id="num" size="20"/>
            <br/>
            <br/>
            <hr />
            <br/>
