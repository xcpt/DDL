<%@ Page Language="C#" AutoEventWireup="true" Inherits="Sys_Stores_Add" %>
...
<table class="table StyleView" border="0" cellspacing="0" scellpadding="0" width="100%">
    <tr>
        ...
        <td align="left">
            <input type="text" class="validate[required,length[1,250]]" name="title" id="storestitle" size="50" maxlength="250" />
        </td>
    </tr>
    <tr>
        <th align="right">
        ...
        <td align="left">
            <input type="radio" value="1" name="Isoutlets" id="Isoutlets_1" /><label for="Isoutlets_1">直营</label>（<input type="checkbox" value="1" name="IsCross" id="IsCross" /><label for="IsCross">跨店消费</label>）
            <input type="radio" value="0" name="Isoutlets" checked="checked" id="Isoutlets_0" /><label for="Isoutlets_0">加盟</label>
        </td>
    </tr>
    <tr>
        <th align="right">
        ...
        <td align="left">
            <input type="text" class="validate[required]" name="opentime" id="storesopentime" onClick="WdatePicker({ skin: 'ext'})" size="10" readonly="readonly" maxlength="50" />
        </td>
    </tr>
    <tr>
        <th align="right">
    ...
    <tr>
        ...
        <td align="left"><input type="text" class="validate[required,length[1,250]]" name="address" id="storesaddress" size="50" maxlength="250" /></td>
    </tr>
    <tr>
        <th align="right">
            上班时间：
        ...
        <td align="left">
			早：<input type="text" name="Worktime" id="storesWorktime" value="9" size="5" />&nbsp;
            晚：<input type="text" name="Closingtime"  id="storesClosingtime" value="18" size="5"/>
        </td>
    </tr>
    <tr>
        <th align="right">
        ...
        <td align="left"><input type="text" class="validate[required,length[1,50]]" name="tel" id="tel" size="50" maxlength="50" /></td>
    </tr>
</table>
</div>
